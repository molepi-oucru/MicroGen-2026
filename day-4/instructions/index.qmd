...
In [Actionable Diagnostics & Clinical Reasoning](clinical-reasoning.qmd), you will move from surveillance to a clinical metagenomics case based on neuroleptospirosis. The lesson focuses on when unbiased sequencing is useful, how CNS infection results should be interpreted, and how metagenomic evidence supports clinical reasoning rather than replacing it.
...
1. [Clinical Foundations & AMR Surveillance](vietnamese-healthy-gut-microbiome.qmd)
2. [Actionable Diagnostics & Clinical Reasoning](clinical-reasoning.qmd)

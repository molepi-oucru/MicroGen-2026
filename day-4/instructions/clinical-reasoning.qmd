...
.protected-reveal button:hover,
.protected-reveal button:focus {
  background: #eef1f4;
  border-color: #adb5bd;
}
.protected-reveal-content {
  display: none;
  margin-top: 0.85rem;
}
summary {
...
```{=html}
<div class="protected-reveal" data-payload="">
  <button type="button" onclick="revealProtectedSource(this)">Reveal source</button>
  <div class="protected-reveal-content" aria-live="polite"></div>
</div>
```
